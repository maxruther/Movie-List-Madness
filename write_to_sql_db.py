...
def drop_old_og_tables(data: list[list[str | list[str | int]]],
    ...
    if og_table_not_in_data:
        ...
        # db, as carried out by the method 'regenerate_tables_with_data()'
        else:
            return False
...
def regenerate_tables_with_data(data: list[list[str | list[str | int]]], db: pymysql.connections.Connection) -> None:
