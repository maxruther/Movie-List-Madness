...
def download_omdb_data(cursor: pymysql.cursors.Cursor,
    ...
    for (Movie_ID, Title, Year) in cursor:
        ...
        if Title == 'Salo':
            curr_title = urllib.parse.quote_plus("Salo, or the 120 "
                                                  "Days of Sodom")
        
        # Detective Pikachu title is finicky with OMDb
        if Title == 'Pokemon Detective Pikachu':
            curr_title = urllib.parse.quote_plus("Detective Pikachu")
